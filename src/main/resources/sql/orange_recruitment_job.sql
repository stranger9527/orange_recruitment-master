...
CREATE TABLE `job` (
  ...
  `salary` varchar(45) NOT NULL COMMENT '前端下拉框选择日薪（200/天）月薪（6000/月）',
  `description` varchar(511) NOT NULL,
  `address` varchar(45) NOT NULL,
  `education_requirement` varchar(45) NOT NULL COMMENT '初中-1、高中-2、本科-3、硕士-4、博士-5\n',
...
INSERT INTO `job` VALUES (1,2,'java开发','200/天','java开发','二仙桥','3',NULL,NULL,NULL,NULL,NULL);
