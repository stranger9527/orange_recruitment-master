...
--
-- Dumping data for table `enterprise_staff`
--

LOCK TABLES `enterprise_staff` WRITE;
/*!40000 ALTER TABLE `enterprise_staff` DISABLE KEYS */;
INSERT INTO `enterprise_staff` VALUES (1,1,2,'HR');
/*!40000 ALTER TABLE `enterprise_staff` ENABLE KEYS */;
UNLOCK TABLES;
